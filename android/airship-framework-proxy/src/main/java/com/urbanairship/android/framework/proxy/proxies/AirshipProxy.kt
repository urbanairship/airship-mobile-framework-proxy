...
public class AirshipProxy(private val context: Context) {
    ...
    public fun takeOff(config: JsonMap?): Boolean {
        proxyStore.airshipConfig = config ?: JsonMap.EMPTY_MAP
    ...
    public fun setNotificationConfig(config: JsonMap?) {
        proxyStore.notificationConfig = NotificationConfig(config ?: JsonMap.EMPTY_MAP)
    }
